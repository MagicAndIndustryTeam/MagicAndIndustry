...
public class UpgradedStructureTileRenderer extends TileEntitySpecialRenderer
{
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f)
	{
		...
		GL11.glPushMatrix();
			...
			RenderHandler.renderBlocks.renderBlockUsingTexture(tile.getWorldObj().getBlock(tile.xCoord, tile.yCoord, tile.xCoord), tile.xCoord, tile.yCoord, tile.zCoord, icon);
