 ...
 * EnumColor.java can be found at https://github.com/aidancbrady/Mekanism/blob/master/common/mekanism/api/EnumColor.java.
 * Thank you, AidanBrady.
 * 
...
public enum TextColor
{
	...
	public static TextColor[] DYES = new TextColor[] {BLACK, DARK_RED, DARK_GREEN, null, DARK_BLUE, PURPLE, DARK_AQUA, GREY, DARK_GREY, PINK, BRIGHT_GREEN, YELLOW, INDIGO, RED, ORANGE, WHITE};
	...
	private TextColor(String s, String n, int[] rgb, int meta)
	{
		code = s;
		unlocalizedName = n;
		rgbCode = rgb;
	...
	{
		return Utils.Translate("color." + unlocalizedName);
	}
	 ...
	 * @return Minecraft block meta value
	 */
